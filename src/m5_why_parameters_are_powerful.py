...
def main():
    ...
    #even_better_draw_circles(rg.Point(100, 50), 5, 10, 'green', 2)
    #even_better_draw_circles(rg.Point(-200, 0), 15, 5, 'blue', 7)

    even_better_draw_circles(rg.Point(-50, -50), 50, 2, 'green', 5)
    even_better_draw_circles(rg.Point(0, -50), 50, 2, 'blue', 5)
    even_better_draw_circles(rg.Point(50, -50), 50, 2, 'orange', 5)
    even_better_draw_circles(rg.Point(-25, -25), 50, 2, 'red', 5)
    even_better_draw_circles(rg.Point(25, -25), 50, 2, 'yellow', 5)
    even_better_draw_circles(rg.Point(-25, -75), 50, 2, 'purple', 5)
    even_better_draw_circles(rg.Point(25, -75), 50, 2, 'brown', 5)
...
def even_better_draw_circles(point, radius, num_circles, color, thickness):
